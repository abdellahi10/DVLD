...
namespace DVLD.Licenses.Local_Licenses.Controls
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        private void _LoadLocalLicenseInfo()
        {
            ...
            {
                dgvLocalLicensesHistory.ColumnHeadersDefaultCellStyle.Font = new Font("Arial", 10, FontStyle.Bold);
        ...
        private void _LoadInternationalLicenseInfo()
        {
            ...
            {
                dgvInternationalLicensesHistory.ColumnHeadersDefaultCellStyle.Font = new Font("Arial", 10, FontStyle.Bold);
        ...
        public void LoadInfo(int DriverID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("There No Driver with ID = " + _DriverID.ToString());
                return;
            }
        ...
        public void LoadInfoByPersonID(int PersonID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("There No Driver Linked Person with ID = " + PersonID.ToString());
                return;
            }
