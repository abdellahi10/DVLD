    ...
    public partial class frmListPeople : Form
    {
        ...
        private void frmListPeople_Load(object sender, EventArgs e)
        {
            ...
            if (dgvPeople.Rows.Count > 0)
            {
                ...
                //Handle Font
                dgvPeople.DefaultCellStyle.Font = new Font("Arial", 10);
                dgvPeople.ColumnHeadersDefaultCellStyle.Font = new Font("Arial", 10, FontStyle.Bold);
                ...
                dgvPeople.Columns[3].Width = 129;


                dgvPeople.Columns[4].HeaderText = "Third Name";
                dgvPeople.Columns[4].Width = 118;

                dgvPeople.Columns[5].HeaderText = "Last Name";
                dgvPeople.Columns[5].Width = 105;
                ...
                dgvPeople.Columns[10].Width = 133;
